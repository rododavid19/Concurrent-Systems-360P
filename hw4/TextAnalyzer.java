...
public class TextAnalyzer extends Configured implements Tool {
    ...
    // Replace "?" with your own output key / value types
        ...
        //we are going to use Text and IntWritable
    ...
    public static class TextMapper extends Mapper<LongWritable, Text, Tuple, IntWritable> {

        private final static IntWritable one = new IntWritable(1);

        String currentWord = "";

        Tuple<String, String> tuplepair = new Tuple("", "");
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            line = line.toLowerCase();//convert every character into lower-case
            String resultString = line.replaceAll("[^\\p{L}\\p{Nd}]+", " ");//mask non-word characters by white-space
    ...
    public static class TextCombiner extends Reducer<LongWritable, Text, Tuple, IntWritable> {
    ...
    public static class TextReducer extends Reducer<Tuple, IntWritable, Text, Text> {
